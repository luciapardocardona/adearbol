...
public class QuestionsConstants
{
    public static Dialogs day1 = new Dialogs
    {
        questions = new PositiveAndNegative
        {
            positive = new People
            {
                ...
                family = "¡Buenos días, cariño! ¿Qué tal has dormido? Aquí tienes tu desayuno. Hoy he hecho tostaditas con bellota. Si no tienes nada que hacer, deberías acercarte al pueblo. ¡Hoy hay un jaleo enorme! Y mira que en este pueblo se está tranquilo... Ay... Me encanta este pueblo. ¿A ti te gusta?",
        ...
        npcAnswers = new PositiveAndNegative
        {
            positive = new People
            {
                ...
                family = "¡Claro que sí, mi niñe! Te quiero mucho, ¡muuuacks!",
            ...
            negative = new People
            {
                ...
                family = "Mmm, bueno, estoy segure de que cambiarás de idea con el pasito del tiempo. Aún eres muy joven para apreciar la tranquilidad...",
    ...
    public static Dialogs day2 = new Dialogs
    {
        questions = new PositiveAndNegative
        {
            positive = new People
            {
                friend = "¡Holaaaa, chatii! ¿Cómo va eso? Va venga, te lo cuento. No me hago más de rogar. ¿Y si montamos una banda de rock? Tú a la batería, yo a la guitarra... Bueno, y ya encontraremos a alguien más pa' completar la banda. Buah... Haríamos giras, viajaríamos por el mundo... ¿No te flipa?",
                family = "¡Buenos días, cariñín! ¿Cómo has dormido? Hoy para desayunar tenemos bellota frita. ¿Has oído lo que se rumorea por el pueblo? Al parecer, ha llegado alguien de fuera que quiere construir no se qué edificio en el pueblo. No me gusta mucho cuando construyen cosas nuevas en el pueblo... y mucho menos si se trata de alguien que no vive aquí porque seguro que no se preocupa por las necesidades de nosotres y les habitantes del pueblo. ¿Qué opinas tú?",
            ...
            negative = new People
            {
                friend = "¡Holiiis! Va venga, te lo cuento. No me hago más de rogar. ¿Y si montamos una banda de rock? Tú a la batería, yo a la guitarra... Bueno, y ya encontraremos a alguien más pa' completar la banda. Buah... Haríamos giras, viajaríamos por el mundo... ¿No te flipa?",
                family = "¡Buenos días! Hoy para desayunar tenemos bellota al vapor. ¿Has oído lo que se rumorea por el pueblo? Al parecer, ha llegado alguien de fuera que quiere construir no se qué edificio en el pueblo. No me gusta mucho cuando construyen cosas nuevas en el pueblo... y mucho menos si se trata de alguien que no vive aquí porque seguro que no se preocupa por las necesidades de nosotres y les habitantes del pueblo. ¿Qué opinas tú?",
        ...
        npcAnswers = new PositiveAndNegative
        {
            positive = new People
            {
                friend = "¿A que sí? Se me ocurrió a mí solite, ¿eh? Estaba en la cama comiendo techo y de repente lo vi... Los focos, el escenario, el público coreándonos...",
    ...
    public static Dialogs day3 = new Dialogs
    {
        ...
        npcAnswers = new PositiveAndNegative
        {
            positive = new People
            {
                friend = "¡Flipa! ¡Vamos a ser les próximes Alvin y las ardillas!",
                ...
                mole = "¡Gracias, majo! Poquito a poco y juntos, conseguiremos darle la importancia que merece a un enclave como este. ¡Ah! Se me olvidaba. Me he enterado de que vives con tu familia en el árbol que teníamos pensado talar... Si sigues conmigo, podemos llegar a un acuerdo para que tu familia y tú no os quedéis sin casa. ¡Solo tienes que apoyarnos en todo!"
            },
            negative = new People
            {
                friend = "Pss, tampoco te me vayas a rajar ahora, ¿eh? Que ya he contratao hasta el chófer pa' la caravana.",
                family = "Pero bueno, ¿cómo que no? Tendrás que ayudar un poquito en esta casa. ¿Qué te crees? ¿Que esto es un hotel? No somos tus sirvientes. Para una cosa que te pido...",
                mole = "¡Vaya mala sombra tienes! Ni un favor puedes hacerme. Vaya con la gente de este pueblo. No os merecéis el esfuerzo y la inversión que estoy haciendo por vosotros."
            }
        },
    };
    ...
    public static Dialogs day4 = new Dialogs
    {
        ...
        npcAnswers = new PositiveAndNegative
        {
            positive = new People
            {
                friend = "¡TOOOMA! La big city es lo más. Prepárate. Nos espera una vida de rockstars.",
                family = "Exacto, el bosque es nuestre amigue. Nosotres le cuidamos, y cuida de nosotres. Todes le debemos mucho.",
                mole = "¡Claro que sí! ¿Cómo no te va a gustar? Visitar sitios nuevos, hacerse fotitos para fardarle a tus amigos, probar chocolates de diferentes orígenes, porque eso es lo que coméis vosotros, ¿no? Claro, sí, chocolate. Además de sacar estereotipos de cada pueblo, como las hurracas... ¡Qué agarradas son, las malnacidas! ¡Que yo tengo amigas hurracas, eh! Jajajaja... Tú ya me entiendes."
            },
            negative = new People
            {
                friend = "Sí, claro, y ahora me dirás que también prefieres el tocino a la velocidad. Vete a casa y mañana lo me dices.",
                family = "¿Cómo dices? No vuelvas a decir algo así en esta casa. Y menos aún en el pueblo. Alguien podría oírte, y qué pensarán de nosotres.",
    ...
    public static Dialogs day5 = new Dialogs
    {
        questions = new PositiveAndNegative
        {
            positive = new People
            {
                friend = "¡Cómo van esas paletas! Ya he metio to' mi equipaje en la caravana, ya tenemos a le chófer, obviamente, porque yo paaaso de conducir.",
            ...
            negative = new People
            {
                friend = "¡Locuele! Ya he metio to' mi equipaje en la caravana, ya tenemos a le chófer, obviamente, porque yo paaaso de conducir.",
        ...
        npcAnswers = new PositiveAndNegative
        {
            positive = new People
            {
                friend = "¡NIQUELAO! Mete la batería donde sea que se guarden las baterías, dile bye a tus viejes y vámonos ¡YA!",
